...
def init_parser():
  global lark_parser
  # TODO: This is different than the original
  # Solution: Create a custom init function that copies, uses the global that this file provides.
  # lark_file = get_deduce_directory() + "/Deduce.lark"
  lark_file = "./Deduce.lark"
